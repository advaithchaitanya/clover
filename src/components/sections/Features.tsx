...
export function Features() {
  return (
    <section
      className="flex min-h-[963px] w-full flex-col overflow-hidden text-white px-16 py-[130px] bg-black max-md:px-5 max-md:py-[100px]"
      aria-label="Features"
    >
      ...
      <div className="w-full mt-20">
        <div className="flex w-full gap-[40px_48px] flex-wrap">
          <Card className="min-h-[293px] flex-1">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/547abc55e6e448d595cf41dc48be6c0f/387ea1fca05ded2ca412e8fb34b367dbd56e017f61800e529f2aafd015a57c60"
              alt=""
              className="w-12 h-12"
            />
          ...
          <Card className="min-h-[293px] w-[427px]">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/547abc55e6e448d595cf41dc48be6c0f/bd9b5461c49ba3aab949f90199e5e62b66bdfea55d709824e8ba706b953ff756"
              alt=""
              className="w-12 h-12"
            />
            <h3 className="text-[32px] font-bold leading-[42px] mt-6">
      ...
      <div className="flex items-center gap-6 mt-20">
        ...
        <Button variant="link" className="flex items-center gap-2">
          Sign Up
          <img
            src="https://cdn.builder.io/api/v1/image/assets/547abc55e6e448d595cf41dc48be6c0f/236f24720dcc7ee36582f6b0cddd8a27704b9bd4670dd3765671fac5383f8a51"
            alt=""
            className="w-6 h-6"
          />
        </Button>
