export function Contact() {
  ...
  return (
    <section
      className="flex w-full flex-col overflow-hidden items-stretch text-center px-16 py-28 bg-black max-md:px-5 max-md:py-[100px]"
      aria-label="Contact"
    >
      ...
      <div className="w-full mt-20">
        <div className="flex w-full gap-8 flex-wrap">
          {contactMethods.map((method, index) => (
            <div
              key={index}
              className="flex min-w-60 flex-col items-stretch flex-1"
            >
              ...
              <div className="flex w-full flex-col items-stretch mt-6">
                ...
                <a
                  href={method.link}
                  className="text-white text-base font-normal underline mt-6"
                >
                  {method.linkText}
                </a>
              </div>
