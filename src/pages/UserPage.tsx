      ...
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8 mt-20">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 text-neutral-50">
          <div>
            ...
            <input type="text" id="username" className="w-full px-3 py-2 border border-gray-300 rounded-md text-black" value={formData.username} onChange={e => setFormData({
            ...formData,
          ...
          <div>
            ...
            <input type="email" id="email" className="w-full px-3 py-2 border border-gray-300 rounded-md text-black" value={formData.email} onChange={e => setFormData({
            ...formData,
          ...
          <div>
            ...
            <input type="password" id="password" className="w-full px-3 py-2 border border-gray-300 rounded-md text-black" value={formData.password} onChange={e => setFormData({
            ...formData,
